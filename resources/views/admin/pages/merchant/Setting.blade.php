            ...
            <div class="p-20 bg-primary rad-10">
                ...
                <div class="mb-15">
                    ...
                    <input type="{{ __('private.Address_ar') }}" id="surname" class="b-none border-ccc p-10 rad-6 d-block w-full"
                        placeholder="{{ __('private.surname') }}" name="surname" value="{{ $data->surname }}" />
                    <div style="color: red">
                        @error('surname')
                            * {{ $message }}
                        @enderror
            ...
            <div class="p-20 bg-primary rad-10">
                ...
                <div class="mb-15">
                    ...
                    <input type="{{ __('private.country') }}" id="country" class="b-none border-ccc p-10 rad-6 d-block w-full"
                        placeholder="{{ __('private.country') }}" name="country" value="{{ $data->country }}" />
                    <div style="color: red">
                        @error('country')
                            * {{ $message }}
                        @enderror
                ...
                <div class="mb-15">
                    ...
                    <input type="text" id="adress" class="b-none border-ccc p-10 rad-6 d-block w-full"
                        placeholder="{{ __('private.Address') }}" name="adress" value="{{ $data->adress }}" />
                    <div style="color: red">
                        @error('adress')
                            * {{ $message }}
                        @enderror
