        ...
        <div class="courses-page change-view d-grid m-20 gap-20">
            <form action="{{ route('createUser.store') }}" method="post">
                ...
                <div class="p-20 bg-primary rad-10">
                    @csrf
                    <h2 class="mt-0 mb-10"> {{ __('private.Register') }}</h2>
                    <div class="mb-15">
                    ...
                    <div class="sec-box mb-15 between-flex bb-eee pb-5">
                        <button class=" bg-transparent  b-none "><a href="{{ route('profile.index') }}" class="button bg-blue c-white btn-shape b-none w-full p-5">
                                {{ __('private.back') }}
                            </a>
                            </button>
